...
#define SPI_CD				30		// von 34 -> 30 "D/C"
...
public:
	...
	void draw_kalt(unsigned char x, unsigned char y);
	void draw_sat(unsigned char x, unsigned char y);
	void draw_linie(unsigned char x,unsigned char y);
	void draw_batterie (unsigned char x,unsigned char y);
	void draw_clock (unsigned char x,unsigned char y);
	void draw_Pfeil (unsigned char x,unsigned char y);
	void draw_no_Pfeil (unsigned char x, unsigned char y);
	void draw_Mil (unsigned char x, unsigned char y);
	void clear_screen();
