...
// Motorkontrollleuchte malen TL
void ssd0323::draw_Mil (unsigned char x, unsigned char y){
	send_command(0x15);
		send_command(x);
		send_command(x+9);
		send_command(0x75);
		send_command(y);
		send_command(y+7);
		send_char(0x00); send_char(0x00); send_char(0x00); send_char(0xFF); send_char(0xFF); send_char(0xFF); send_char(0x00); send_char(0x00); send_char(0x00); send_char(0x00);
		send_char(0x00); send_char(0x00); send_char(0x00); send_char(0x00); send_char(0xFF); send_char(0x00); send_char(0x00); send_char(0x00); send_char(0x00); send_char(0x00);
		send_char(0x0F); send_char(0x00); send_char(0x0F); send_char(0xFF); send_char(0xFF); send_char(0xFF); send_char(0xF0); send_char(0x00); send_char(0x00); send_char(0x0F);
		send_char(0xFF); send_char(0x00); send_char(0xFF); send_char(0x00); send_char(0x00); send_char(0x00); send_char(0x0F); send_char(0xFF); send_char(0xF0); send_char(0xFF);
		send_char(0xFF); send_char(0xFF); send_char(0xFF); send_char(0x00); send_char(0x00); send_char(0x00); send_char(0x00); send_char(0x00); send_char(0xF0); send_char(0xF0);
		send_char(0x0F); send_char(0x00); send_char(0xFF); send_char(0x00); send_char(0x00); send_char(0x00); send_char(0x00); send_char(0x00); send_char(0xF0); send_char(0xFF);
		send_char(0x0F); send_char(0x00); send_char(0x0F); send_char(0x00); send_char(0x00); send_char(0x00); send_char(0xFF); send_char(0xFF); send_char(0xF0); send_char(0xF0);
		send_char(0x00); send_char(0x00); send_char(0x00); send_char(0xFF); send_char(0xFF); send_char(0xFF); send_char(0xF0); send_char(0x00); send_char(0x00); send_char(0xFF);
}

void ssd0323::draw_oil(unsigned char x,unsigned char y){// �lkanne malen TL
	send_command(0x15);
	send_command(x);
	send_command(x+9);
	send_command(0x75);
...
//Satellitensymbol malen
void ssd0323::draw_sat(unsigned char x,unsigned char y){
	send_command(0x15);
		send_command(x);
		send_command(x+3);
		send_command(0x75);
		send_command(y);
		send_command(y+7);
			send_char(0x00);  send_char(0x00);  send_char(0x00);send_char(0x00);
			send_char(0xFF);  send_char(0xFF);  send_char(0xF0);send_char(0x00);
			send_char(0x00);  send_char(0x00);  send_char(0x0F);send_char(0x00);
			send_char(0xFF);  send_char(0xF0);  send_char(0x00);send_char(0xF0);
			send_char(0x00);  send_char(0x0F);  send_char(0x00);send_char(0xF0);
			send_char(0xFF);  send_char(0x00);  send_char(0xF0);send_char(0xF0);
			send_char(0x00);  send_char(0xF0);  send_char(0xF0);send_char(0xF0);
			send_char(0xF0);  send_char(0xF0);  send_char(0xF0);send_char(0xF0);
};
//Tom malt mal was
//Kuehlschrank
void ssd0323::draw_kalt(unsigned char x,unsigned char y){
	send_command(0x15);
		send_command(x);
		send_command(x+4);
		send_command(0x75);
		...
		send_char(0xF0);send_char(0x00);  send_char(0xF0);  send_char(0x00);send_char(0xF0);
		send_char(0x0F);send_char(0xF0);  send_char(0xF0);  send_char(0xF0);send_char(0x0F);
		send_char(0xFF);send_char(0xFF);  send_char(0xFF);  send_char(0xFF);send_char(0xFF);
		send_char(0xF0);send_char(0xF0);  send_char(0xF0);  send_char(0xF0);send_char(0x0F);
		send_char(0x00);send_char(0x0F);  send_char(0xF0);  send_char(0x0F);send_char(0x00);
		send_char(0x00);send_char(0xF0);  send_char(0xF0);  send_char(0x00);send_char(0xF0);
		send_char(0x0F);send_char(0x00);  send_char(0xF0);  send_char(0x00);send_char(0x00);
};

void ssd0323::draw_Pfeil(unsigned char x,unsigned char y){
	send_command(0x15);
		send_command(x);
		send_command(x+4);
		send_command(0x75);
		send_command(y);
		send_command(y+9);
		send_char(0x00);send_char(0x0F);  send_char(0x00);  send_char(0x00);send_char(0x00);
		send_char(0x00);send_char(0xFF);  send_char(0xF0);  send_char(0x00);send_char(0x00);
		send_char(0x0F);send_char(0xFF);  send_char(0xFF);  send_char(0x00);send_char(0x00);
		send_char(0xFF);send_char(0xFF);  send_char(0xFF);  send_char(0xF0);send_char(0x00);
		send_char(0x00);send_char(0xFF);  send_char(0xF0);  send_char(0x00);send_char(0x00);
		send_char(0x00);send_char(0xFF);  send_char(0xF0);  send_char(0x00);send_char(0x00);
		send_char(0x00);send_char(0xFF);  send_char(0xF0);  send_char(0x00);send_char(0x00);
		send_char(0x00);send_char(0xFF);  send_char(0xF0);  send_char(0x00);send_char(0x00);
...
void ssd0323::draw_no_Pfeil(unsigned char x,unsigned char y){
	send_command(0x15);
		send_command(x);
		send_command(x+4);
		send_command(0x75);
		send_command(y);
		send_command(y+9);
		send_char(0x00);send_char(0x00);  send_char(0x00);  send_char(0x00);send_char(0x00);
		send_char(0x00);send_char(0x00);  send_char(0x00);  send_char(0x00);send_char(0x00);
		send_char(0x00);send_char(0x00);  send_char(0x00);  send_char(0x00);send_char(0x00);
		send_char(0x00);send_char(0x00);  send_char(0x00);  send_char(0x00);send_char(0x00);
		send_char(0x00);send_char(0x00);  send_char(0x00);  send_char(0x00);send_char(0x00);
...
void ssd0323::draw_linie(unsigned char x,unsigned char y)
{
	send_command (0x15);
		send_command (x);
		send_command (x+63);
		...
		send_command (y);
		send_command (y+7);
		send_char(0xFF);  send_char(0xFF);  send_char(0xFF);
				send_char(0xFF);  send_char(0xFF);  send_char(0xFF);
				send_char(0xFF);  send_char(0xFF);  send_char(0xFF);
				send_char(0xFF);  send_char(0xFF);  send_char(0xFF);
				send_char(0xFF);  send_char(0xFF);  send_char(0xFF);
...
void ssd0323::draw_batterie(unsigned char x,unsigned char y)
{
	send_command(0x15);
		send_command(x);
		send_command(x+9);
		...
		send_char(0x00);  send_char(0x0F);  send_char(0xFF);send_char (0x00);send_char(0x00);send_char(0x00);send_char(0xFF);send_char(0xF0);send_char(0x00);send_char(0x00);
		send_char(0x0F);  send_char(0xFF);  send_char(0xFF);send_char (0xFF);send_char(0xFF);send_char(0xFF);send_char(0xFF);send_char(0xFF);send_char(0xF0);send_char(0x00);
		send_char(0x0F);  send_char(0x00);  send_char(0x00);send_char (0x00);send_char(0x00);send_char(0x00);send_char(0x00);send_char(0x00);send_char(0xF0);send_char(0x00);
		send_char(0x0F);  send_char(0x00);  send_char(0xF0);send_char (0x00);send_char(0x00);send_char(0x00);send_char(0x00);send_char(0x00);send_char(0xF0);send_char(0x00);
		send_char(0x0F);  send_char(0x0F);  send_char(0xFF);send_char (0x00);send_char(0x00);send_char(0xFF);send_char(0xFF);send_char(0xF0);send_char(0xF0);send_char(0x00);
		send_char(0x0F);  send_char(0x00);  send_char(0xF0);send_char (0x00);send_char(0x00);send_char(0x00);send_char(0x00);send_char(0x00);send_char(0xF0);send_char(0x00);
		send_char(0x0F);  send_char(0x00);  send_char(0x00);send_char (0x00);send_char(0x00);send_char(0x00);send_char(0x00);send_char(0x00);send_char(0xF0);send_char(0x00);
		send_char(0x0F);  send_char(0xFF);  send_char(0xFF);send_char (0xFF);send_char(0xFF);send_char(0xFF);send_char(0xFF);send_char(0xFF);send_char(0xF0);send_char(0x00);
}
...
void ssd0323::line(unsigned char x,unsigned char y,unsigned char x2,unsigned char y2,unsigned char color){
	if(abs(x-x2)>=abs(y-y2)){ // für flache kurven viele x für wenig y werte
		...
		for(int i=y; i>=klein && i<=gr; i=i+dir) {
			...
			send_command(i);
			send_command(i);
			if(char(round((x2-(y2-i)*m/100)))%2==0){ // links
				send_char((color&0x0f)<<4);
			} else { // rechts
				send_char(color&0x0f);
			}
